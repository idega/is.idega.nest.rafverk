 ...
 */
package is.idega.nest.rafverk.bean.constants;
...
public class FieldID {
	...
	public final static String SWITCH_PANEL_NUMBER = "switchPanelNumber";
	public final static String VOLTAGE_SYSTEM_GROUP = "voltageSystemGroup";
	public final static String VOLTAGE_SYSTEM = "voltageSystem";
	public final static String VOLTAGE_SYSTEM_OTHER = "voltageSystemOther";
	// maelir / meter 
